				...
				if (!empty($arrQuestion)) {
					...
					foreach ($arrQuestion as $key => $value) {
						...
						$xhtml .= '<div class="form-group">
                                ...
                                <div class="row">
                                <div class="col-md-4">' . $option0 . $option1 . '</div>
                                <div class="col-md-4">' . $option2 . $option3 . '</div>
                                </div>
                                </div>';
						$i++;
					}
			...
			?>
                ...
                <form action="result.php" method="post" name="test-form" id="test-form">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="array-data"
                               value="<?php echo htmlentities(serialize($arrQuestion)); ?>"/>
